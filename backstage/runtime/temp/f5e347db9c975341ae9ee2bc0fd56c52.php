...
<![endif]-->
<title><?php echo (isset($title) && ($title !== '')?$title:'商城后台登录'); ?></title>
...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal login" action="" method="post">
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<input name="verify" class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" value="" onclick="if(this.value=='验证码:'){this.value='';}" style="width:150px;">
